<?php include 'dbCon.php';
   ...
   //  $mStatus=mysqli_real_escape_string($con,$_POST['mStatus']);
     ...
     //$occupationSpouse=mysqli_real_escape_string($con,$_POST['occupationSpouse']);
     //$busAddress=mysqli_real_escape_string($con,$_POST['busAddress']);
...
if((isset($_SESSION['name'])&&!empty($_SESSION['name']))||(isset($_SESSION['surname'])&&!empty($_SESSION['surname']))||(isset($_SESSION['address'])&&!empty($_SESSION['address']))||(isset($_SESSION['idNum'])&&!empty($_SESSION['idNum']))||(isset($_SESSION['dob'])&&!empty($_SESSION['dob']))||(isset($_SESSION['prevStand'])&&!empty($_SESSION['prevStand']))||(isset($_SESSION['income'])&&!empty($_SESSION['income']))||(isset($_SESSION['address2'])&&!empty($_SESSION['address2']))||(isset($_SESSION['mStatus'])&&!empty($_SESSION['mStatus']))||(isset($_SESSION['occupationApplicant'])&&!empty($_SESSION['occupationApplicant']))||(isset($_SESSION['occupationSpouse'])&&!empty($_SESSION['occupationSpouse']))||(isset($_SESSION['busAddress'])&&!empty($_SESSION['busAddress']))||(isset($_SESSION['cellphone'])&&!empty($_SESSION['cellphone']))||(isset($_SESSION['dependents'])&&!empty($_SESSION['dependents']))||(isset($_SESSION['yearsOfRes'])&&!empty($_SESSION['yearsOfRes'])))
{
    ...
    $_SESSION['address2']=mysqli_real_escape_string($conn,$_POST['address2']);
    $_SESSION['mStatus']=mysqli_real_escape_string($conn,$_POST['mStatus']);
    $_SESSION['occupationApplicant']=mysqli_real_escape_string($conn,$_POST['occupationApplicant']);
    $_SESSION['occupationSpouse']=mysqli_real_escape_string($conn,$_POST['occupationSpouse']);
    $_SESSION['busAddress']=mysqli_real_escape_string($conn,$_POST['busAddress']);
    $_SESSION['cellphone']=mysqli_real_escape_string($conn,$_POST['cellphone']);
    $_SESSION['dependents']=mysqli_real_escape_string($conn,$_POST['dependents']);
    $_SESSION['yearsOfRes']=mysqli_real_escape_string($conn,$_POST['yearsOfRes']);

  }else{
		
		echo '<script type="text/javascript"> alert("cannot access this page without filling first page ");</script>';
		header("location: residential2.php");//redirecting to first page);
	}
			...
			<div class="login1">
			  ...
			  <h4> Enter details</h4>
				  <form action="postRes.php" method="post" enctype="multipart/form-data">
					  <input type="text" placeholder="Nature of development intended" name="natureofDev" required>
					  <input type="text" placeholder="Other properties lease owned in Zimbabwe" name="otherProperties" required>
					  <input type="text" placeholder="Amount of capital available for development" name="amtOfCapital" required>
