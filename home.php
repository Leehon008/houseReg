            ...
            <div class="row" id="logo-headersidebar-container">
                ...
                <div id="logo" class="span6 group">
                    <a id="logo-img" href="index.html" title="KTC">
                        <img width="70" height="60" src="images/ktc-logo1.png" title="KTC" alt="KTC" />
                    </a>
...
<!-- BEGIN NIVO SLIDER -->
        <div id="slider-flexslider-elegant-0" class="slider slider-flexslider-elegant flexslider-elegant container">
    	   	<div class="slider-wrapper">
                <ul class="slides">
                    <li>
                    	<img width="600" height="200" src="images/new/housing2.jpg" class="attachment-full" alt="001" />
                        <div class="slider-caption caption-right">
                            <div class="caption-wrapper">
                                <h2>BE NICE. BE ORIGINAL.</h2>
                                <h4></h4>
                                <p>
                                There is nothing wrong with owning a land for yourself so what are your waiting for? <br/>
                                Go get yoursef a contract.
                                </p>
                                <span class="special-font" style="font-size:24px;">
                                    Go Tell your Loved
                                    <span style="font-size: 30px;">Friends and Family</span>
                                </span>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                    	<img width="600" height="200" src="images/new/housing1.jpg" class="attachment-full" alt="002" />
                        <div class="slider-caption caption-right">
                            <div class="caption-wrapper">
                                <h2>WITH KTC HOUSING PROJECT,WE WILL MAKE YOU HAPPY.</h2>
                                <h4></h4>

                                <p>
                                    Be The first to rush for a Stand of your own And prepare a future for your family. <br>
                                    Consult with our offices for more elegant information about any queries you might have.
                                </p>
                                <span class="special-font" style="font-size:24px;">
                                    Love your
                                    <span style="font-size: 30px;">Investment</span>
                                </span>
                            </div>
                        </div>
                    </li>
                    <li>
                    	<img width="600" height="200" src="images/new/housing4.jpg" class="attachment-full" alt="003" />
                            <div class="slider-caption caption-right">
                            <div class="caption-wrapper">
                                <h2>MULTIPURPOSE PROJECT</h2>
                                <h4></h4>
                                <p>
                                    We are offering stands for a multipurpose usage that ranges from small scale holdings to medium scale Shops.The small scale comprises of low density to high density housing. There is also room for those who want Commercial stands.
                                </p>
                                <p>&nbsp;</p>

                                <span class="special-font" style="font-size:24px;">
                                    A lucrative
                                    <span style="font-size: 30px;">Investment theme</span>
                                </span>
                            </div>
                        </div>
                    </li>
                ...
                <div id="content-home" class="span12 content group">
                    <div class="page type-page status-publish hentry group">
                        <div class="box-sections numbers-sections margin-bottom ">
                                ...
                                <h4>
                                    Residential <span class="title-highlight">solutions</span>
                                </h4>
                                <p>
                                    We are offering stands for a multipurpose usage that ranges from low density to high density housing. So any choice of yours is what we are prepared to discuss with you. 
                                </p>
                                <p>
                               <a href="residential.php" class="more-link">|| Apply for these stands Here</a> 
                                                </p>
                        </div>
                        ...
                        <div class="box-sections numbers-sections margin-bottom ">
                            ...
                            <h4>
                                Commercial <span class="title-highlight">Solutions</span>
                            </h4>
                            <p>
                                We are offering stands for a multipurpose usage that ranges from small scale holdings to medium scale Shops.The Council is providing space for some commercial activities so there is also room for those who want Commercial stands.
                            </p>
                          <p>
                               <a href="commercial.php" class="more-link">|| Apply for these stands Here</a> 
                                                </p>
                        </div>
                        ...
                        <div class="box-sections numbers-sections margin-bottom  last">
                            ...
                            <p>
                                If you want other Related services please feel free to come visit our offices so that we may help each other in growing our area.
                            </p>
                            <a href="get-in-touch.html" class="more-link">|| Add more flesh Here</a> 
                                                </p>
                        </div>
                        <div class="clear"></div>
                        <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="the-content span3">
                                              ...
                                              We are offering stands for a multipurpose usage that ranges from small scale holdings to medium scale Shops.The Council is providing space for some commercial activities so there is also room for those who want Commercial stands.
                                                ...
                                                <p>
                                                    If you want other Related services please feel free to come visit our offices so that we may help each other in growing our area.<strong>Its Real here</strong>Hurry while the list is still small.
                                                </p>

                                                <p>
                                                    <a href="blog-detail.html" class="more-link">|| read More about these stands</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post type-post status-publish format-standard category-design category-themes tag-cleam tag-corporate tag-minimal span3">
                                        <div class="row">
                                            ...
                                            <div class="meta span2">
                                                ...
                                                <p class="author">by <strong>Lee Hon</strong></p>
                                                <p class="comments">
                                   ...
                                   <div class="post type-post status-publish format-audio category-themes span3">
                                        <div class="row">
                                            ...
                                            <div class="meta span2">
                                                <h4>
                                                    <a href="blog-detail.html" title="Another Location Offered!">
                                                        Another Location 
                                                    </a>
                                                </h4>
                                                <p class="author">by <strong>Lee Hon</strong></p>
                                                <p class="comments">
                                                    <a href="##respond" title="Comment on Another Location Offered!">
                                                        <strong>Comments:</strong> 0
                                                    </a>
                                                </p>
                                            </div>
                                    ...
                                    <div class="post type-post status-publish format-quote category-uncategorized span3">
                                        <div class="row">
                                            ...
                                            <div class="meta span2">
                                                <h4>
                                                    <a href="blog-detail.html" title="Lee Hon">
                                                        Chiedza Wilder
                                                    </a>
                                                </h4>
                                                <p class="author">by <strong>Lee Hon</strong></p>
                                                <p class="comments">
                                                    <a href="#respond" title="Comment on Chiedza Wilder">
                                                        <strong>Comments:</strong> 0
                                                    </a>
                                                </p>
                                            </div>
                                            ...
                                            <div class="meta span2">
                                                <h4>
                                                    <a href="blog-detail.html" title="This is the title of the first article. Enjoy it.">
                                                        This is the title of the first allocation. Enjoy it.
                                                    </a>
                                                </h4>
                                                <p class="author">by <strong>Lee Hon</strong></p>
                                                <p class="comments">
                                                    <a href="##comments" title="Comment on This is the title of the first allocation. Enjoy it.">
