...
<!-- START WRAPPER -->
    ...
    <div class="body1">
      <div class="login1">
        ...
        <h4> Enter details For Commercial Stand Application</h4>
          <form action="commercial2.php" method="post">
            ...
            <input type="text" placeholder="Previous Commercial Stand Number" name="prevStand" required/>
