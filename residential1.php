    ...
    <div id="wrapper" class="container group">
		...
		<div class="body1">
			<div class="login1">
			  ...
			  <h4> Enter details for Residential Stand Application</h4>
				  <form action="test1.php" method="post" >
					  <input type="text" placeholder="Name" name="name" id="name" required>
					  <input type="text" placeholder="Surname" name="surname" id="surname"required>
					  <input type="text" placeholder="Address" name="address"  id="address" required>
					  <input type="text" placeholder="Enter National ID" name="idNum" id="idNum" required>
                      <input type="text" placeholder="Date of Birth of Applicant" name="dob" required>
					  <input type="text" placeholder="Previous Stand Number" name="prevStand" required>
                      <input type="text" placeholder="Monthly income of applicant" name="income" required>
    				  <input type="text" placeholder="Address2" name="add2" required>
					  <input type="text" placeholder="Marriage Status" name="mStatus" required>
					  <input type="text" placeholder="Occupation Applicant" name="occupationApplicant" required>
                      <input type="text" placeholder="Occupation Spouse" name="occupationSpouse" required>
					  <input type="text" placeholder="Business address" name="busAddress" required>
                      <input type="text" placeholder="Cell Phone" name="cellphone" required>
                      <input type="text" placeholder="Number of dependants" name="dependents" required>
                      <input type="text" placeholder="Number of years residing in council area" name="yearsOfRes" required>
                      ...
                      <input type="submit" value="Register" class="btn1 btn1-primary"/>
